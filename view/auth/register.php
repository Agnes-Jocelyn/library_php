            ...
            <div class="card-body">
                ...
                <form action="../../model/auth/RegisterController.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="fullname" class="form-control" placeholder="Input your fullname here" required>
                   </div>
                    <div class="form-group">
                   ...
                   <div class="form-group">
                        ...
                        <input type="password" name="password_conf" class="form-control" placeholder="Confirm your password here" required>
                   </div>
                   <div class="form-group">
                        <button class="btn btn-info btn-block" name="register_user">Register</button>
                   </div>
                   <div class="form-group">
